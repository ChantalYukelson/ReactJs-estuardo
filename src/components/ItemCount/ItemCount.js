    ...
    <>
      <div className="d-flex justify-content-center text-center align-items-center contador counter-input input-group mb-3">
        <div className="input-group-prepend">
          <Button onClick={handleRestar} className="btn btn-secondary btn-sm">
            -
          </Button>
        </div>
        <input type="text" className="form-control h-100 text-center" readOnly value={count} />
        <div className="input-group-append">
          <Button onClick={handleAgregar} className="btn btn-secondary btn-sm">
            +
          </Button>
        </div>
        <Button onClick={handleOnAdd} className="btn btn-dark btn-hover-white btn-sm m-2">
          Agregar al carrito
        </Button>
      </div>
    </>
